  ...
  return (
    <>
      <Head>
        ...
        <meta 
          name="description" 
          content="AUVTEK specializes in cutting-edge Autonomous Underwater Vehicles (AUV), Unmanned Underwater Vehicles (UUV), Sonar Systems, and Acoustic Sensors for marine research, exploration, and industrial applications." 
        />
        <meta 
          name="keywords" 
          content="AUV, UUV, Autonomous Underwater Vehicle, Unmanned Underwater Vehicle, Sonar, Acoustic Sensor, Underwater Technology, Marine Exploration, Oceanography, Hydrophone, Underwater Robotics, Underwater Imaging, Synthetic Aperture Sonar, Marine Research" 
        />
        <meta name="author" content="AUVTEK" />
        <meta property="og:title" content="AUVTEK - Underwater Autonomous Technology & Acoustic Solutions" />
        <meta property="og:description" content="Advanced underwater autonomous platforms and acoustic sensors for research, exploration, and innovation" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://auvtek.com" />
